...
when the document is a skill. Frontmatter, the invocation choice, and router
...
- A **user-invoked** skill strips the description from the agent's reach:
  only the human typing its name can invoke it, and no other skill can. Zero
  ...
  `description` becomes human-facing, a one-line summary with trigger lists
  stripped.
